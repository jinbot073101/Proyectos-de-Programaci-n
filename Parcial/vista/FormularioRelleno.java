...
import controlador.ControlFormularioRelleno;
...
public class FormularioRelleno extends JFrame {
    ...
    private final ControlFormularioRelleno controlFormularioRelleno;
    ...
    public FormularioRelleno(ControlGeneral control) {
        this.controlador = control;
        controlFormularioRelleno = new ControlFormularioRelleno(this);
        ...
        clasificacionComboBox.addActionListener(e -> {
            ...
            controlFormularioRelleno.actualizarSubMenu(selectedItem);
        });
    }

...
import javax.swing.*;
import servicios.GestorVistaFormulario;

public class FormularioRelleno extends JFrame {

    private final GestorVistaFormulario gestorVistaFormulario;
    ...
    public FormularioRelleno() {
        this.gestorVistaFormulario = new GestorVistaFormulario(this);

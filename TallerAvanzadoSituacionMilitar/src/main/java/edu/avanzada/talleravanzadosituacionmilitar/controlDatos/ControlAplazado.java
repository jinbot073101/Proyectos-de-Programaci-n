 ...
 * y sus interacciones con un ArrayList que almacena dichos objetos. Proporciona
 * métodos para ingresar, consultar, cambiar el estado de una persona y generar
 * reportes sobre las personas en estado aplazado.
 */
public class ControlAplazado implements InterfaceControl {
    ...
    /**
     * Constructor que inicializa el controlador de la base de datos y la lista
     * de personas en estado aplazado.
     *
     * @param controlDatos instancia del controlador que maneja la base de datos
    ...
    /**
     * Método para ingresar una persona en estado aplazado. Verifica si la
     * persona ya está registrada antes de crear un nuevo objeto y añadirlo al
     * ArrayList.
     *
    ...
    /**
     * Método que crea un objeto de tipo {@link Aplazado} con los datos
     * ingresados por el usuario.
     *
     * @param cedula el número de cédula de la persona aplazada.
     * @return un objeto de tipo {@link Persona} con los datos de la persona
     * aplazada.
     */
    public Persona crearAplazado(int cedula) {
     ...
     * Solicita la cédula del usuario a consultar y muestra su información si se
    ...
    /**
     * Método para cambiar el estado militar de una persona. Solicita la cédula
     * de la persona y permite cambiar su situación a uno de los otros estados
     * disponibles.
     */
    @Override
            ...
            for (Persona objPersona : baseDatosAplazados) {
                if (cedula == objPersona.getCedula()) {
                    ...
                    switch (opcion) {
                        ...
                        case 3 ->
                            System.out.println("El usuario ya se encuentra en este estado\n");
                        case 4 -> {
                            System.out.println("\\t>>Cambiando estado....");
    ...
    /**
     * Verifica si una persona con la cédula dada ya está registrada en la lista
     * de personas aplazadas.
     *
    ...
    /**
     * Muestra la lista completa de personas aplazadas almacenadas en el
     * ArrayList.
     */

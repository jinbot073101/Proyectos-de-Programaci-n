...
public class ControlRemisoTest {
    ...
    public void setUp() {
        ...
        when(mockControlBaseDatos.getListaPorEstado("Remiso")).thenReturn((ArrayList<Persona>) listaPersonas);

        // Instanciar ControlAplazado usando el mock
        controlRemiso = new ControlRemiso(mockControlBaseDatos);
    }
    ...
    public void testVerificarArrayConCedulaExistente() {
        ...
        assertTrue(controlRemiso.verificarArray(123456), "La cédula debería estar en la base de datos.");
    }
    ...
    public void testVerificarArrayConCedulaNoExistente() {
        ...
        assertFalse(controlRemiso.verificarArray(111111), "La cédula no debería estar en la base de datos.");
    }
}
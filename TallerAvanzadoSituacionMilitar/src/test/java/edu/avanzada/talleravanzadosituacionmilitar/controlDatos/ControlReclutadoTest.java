...
public class ControlReclutadoTest {
    ...
    public void setUp() {
        ...
        persona1 = new Reclutado();
        persona1.setCedula(123456);
        persona2 = new Reclutado();
        ...
        when(mockControlBaseDatos.getListaPorEstado("Reclutado")).thenReturn((ArrayList<Persona>) listaPersonas);

        // Instanciar ControlAplazado usando el mock
        controlReclutado = new ControlReclutado(mockControlBaseDatos);
    }
    ...
    public void testVerificarArrayConCedulaExistente() {
        ...
        assertTrue(controlReclutado.verificarArray(123456), "La cédula debería estar en la base de datos.");
    }
    ...
    public void testVerificarArrayConCedulaNoExistente() {
        ...
        assertFalse(controlReclutado.verificarArray(111111), "La cédula no debería estar en la base de datos.");
    }
}

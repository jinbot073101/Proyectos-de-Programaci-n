...
public class ControlRegistro {
    ...
    public ControlRegistro(ControladorPrincipal gestor) {
        juezCreado = false;
        this.gestor = gestor;
            ...
            gestor.getRegistrarJugadorVista().setRegistrarJugador(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        ...
                        String strPosicion = Integer.toString(gestor.getRegistrarJugadorVista().obtenerPosicionJugador());
        ...
        this.gestor.getRegistrarJuezVista().setJuez(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String strTarjetaProfesional = Integer.toString(gestor.getRegistrarJuezVista().obtenerTarjetaProfesional());
